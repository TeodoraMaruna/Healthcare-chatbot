...
# print("VVV: ", tf.config.list_physical_devices('GPU'))
...
from tensorflow.keras.layers import Dense, Embedding, LSTM, Input, Bidirectional, Concatenate, Dropout, Attention, GRU
...
# model.save('chatbot_doctor_glove_f1_gru.h5')
# model.save_weights('chatbot_weights_doctor_glove_f1_gru.h5')
model.load_weights('chatbot_weights_doctor_glove_f1_source.h5')
