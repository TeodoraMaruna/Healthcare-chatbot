...
# # treniranje modela
# history = model.fit([encoder_inp, decoder_inp], decoder_final_output, epochs=110, batch_size=64, validation_split=0.15)
# model.save('chatbot_doctor_glove_intents_110_64.h5')
# model.save_weights('chatbot_weights_doctor_glove_intents_110_64.h5')
model.load_weights('chatbot_weights_doctor_glove_intents_110_64.h5')
...
# plt.savefig('acc_intents_110_64.svg')
# plt.show()
...
# plt.xlabel('epoch')
# plt.legend(['Train', 'Validation'], loc='upper left')
# plt.savefig('loss_intents_110_64.svg')
# plt.show()
