...
f = open('conversation_dataset_without_intents.json')
data = json.load(f)
...
with open('conversation_dataset_without_intents_train.json', 'w') as outfile:
    outfile.write(full_data_json)
    
full_data_json = json.dumps(data_ouput1,indent=4)
    
with open('conversation_dataset_without_intents_test.json', 'w') as outfile:
    outfile.write(full_data_json)